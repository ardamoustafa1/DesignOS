# SaaS Pricing Page Recipe

```text
Design a SaaS pricing page.

Audience: teams comparing plans before talking to sales.
Goal: make plan choice obvious and reduce pricing anxiety.
Tone: clear, trustworthy, direct.

Load:
- DesignOS/patterns/pricing.md
- DesignOS/components/cards.md
- DesignOS/components/tabs-accordions.md
- DesignOS/psychology/trust.md
